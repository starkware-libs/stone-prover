...
class LdeManagerMock : public LdeManager {
  ...
  */
  ...
  MOCK_CONST_METHOD1(GetEvaluationDegree, int64_t(uint64_t evaluation_idx));
  MOCK_CONST_METHOD1(GetCoefficients, ConstFieldElementSpan(uint64_t evaluation_idx));
