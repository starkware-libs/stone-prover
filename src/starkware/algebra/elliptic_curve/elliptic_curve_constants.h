...
#ifndef STARKWARE_ALGEBRA_ELLIPTIC_CURVE_ELLIPTIC_CURVE_CONSTANTS_H_
#define STARKWARE_ALGEBRA_ELLIPTIC_CURVE_ELLIPTIC_CURVE_CONSTANTS_H_
...
/*
  ...
  k_point1 and k_point2 are points on the curve that were generated independently in a "nothing up
  my sleeve" manner to ensure that no one knows their discrete log.
...
/*
  This elliptic curve over the prime field PrimeFieldElement<252,0> was chosen in a "nothing up my
  sleeve" manner in order to show that we don't know any special properties of this curve (other
  than being of prime order).

  The prime defining the field PrimeFieldElement<252,0> was chosen to be the smallest prime of the
  form 2^251 + k*2^192 + 1. This form ensures that the field is FFT friendly. It also minimizes the
  number of operations in montgomery multiplication (because of the zeros in the middle words). The
  2^251 term is there to leave 4 bits in the MSByte for the FftButterfly.
  ...
  beta was generated in the folowing way:
...
.
*/
const EllipticCurveConstants<PrimeFieldElement<252, 0>> kPrimeFieldEc0(
    // k_alpha
    0x1_Z,
    // k_beta
...
#endif  // STARKWARE_ALGEBRA_ELLIPTIC_CURVE_ELLIPTIC_CURVE_CONSTANTS_H_
