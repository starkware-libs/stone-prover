...
class CpuAirDefinition<FieldElementT, 3> : public Air {
 public:
  ...
  static constexpr uint64_t kPedersenBuiltinRowRatio = 128;
  ...
  static constexpr uint64_t kEcdsaBuiltinRowRatio = 8192;
  ...
  static constexpr uint64_t kBitwiseRowRatio = 4096;
  static constexpr uint64_t kBitwiseTotalNBits = 251;
  static constexpr uint64_t kEcOpBuiltinRatio = 256;
  static constexpr uint64_t kEcOpBuiltinRowRatio = 4096;
  ...
  enum Constraints {
    ...
    kRangeCheckBuiltinValueCond,                                    // Constraint 142.
    kRangeCheckBuiltinAddrStepCond,                                 // Constraint 143.
    kRangeCheckBuiltinInitAddrCond,                                 // Constraint 144.
