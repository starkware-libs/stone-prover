...
CpuAirDefinition<FieldElementT, 1>::CreateCompositionPolynomial(
...
CpuAirDefinition<FieldElementT, 1>::PrecomputeDomainEvalsOnCoset(
  ...
  std::vector<std::vector<FieldElementT>> precomp_domains = {
      ...
      FieldElementT::UninitializedVector(512),  FieldElementT::UninitializedVector(4096),
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo& task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[13][i] = (point_powers[9][i & (4095)]) - (shifts[1]);
        }
      },
      period, kTaskSize);
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo& task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[14][i] = (point_powers[9][i & (4095)]) - (shifts[4]);
        }
      },
      period, kTaskSize);
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo& task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[15][i] = (point_powers[9][i & (4095)]) - (FieldElementT::One());
        }
      },
      period, kTaskSize);
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo& task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[16][i] = (point_powers[10][i & (8191)]) - (shifts[1]);
        }
      },
      period, kTaskSize);
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo& task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[17][i] = (point_powers[10][i & (8191)]) - (shifts[4]);
        }
      },
      period, kTaskSize);
  ...
  task_manager.ParallelFor(
      ...
      [&](const TaskInfo& task_info) {
        for (size_t i = task_info.start_idx; i < task_info.end_idx; ++i) {
          precomp_domains[18][i] = (point_powers[10][i & (8191)]) - (FieldElementT::One());
        }
      },
      period, kTaskSize);
...
template <typename FieldElementT>
FractionFieldElement<FieldElementT> CpuAirDefinition<FieldElementT, 1>::ConstraintsEval(
  ...
  // domain23 = point - gen^(trace_length - 128).
  const FieldElementT& domain23 = (point) - (shifts[8]);
  // domain24 = point - gen^(trace_length - 8192).
  const FieldElementT& domain24 = (point) - (shifts[9]);

  ASSERT_VERIFIER(neighbors.size() == 200, "neighbors should contain 200 elements.");
  ...
  const FieldElementT& column19_row25 = neighbors[kColumn19Row25Neighbor];
  const FieldElementT& column19_row28 = neighbors[kColumn19Row28Neighbor];
  const FieldElementT& column19_row31 = neighbors[kColumn19Row31Neighbor];
  ...
  const FieldElementT& column19_row4103 = neighbors[kColumn19Row4103Neighbor];
  const FieldElementT& column19_row4111 = neighbors[kColumn19Row4111Neighbor];
  ...
  const FieldElementT& column20_row16 = neighbors[kColumn20Row16Neighbor];
  const FieldElementT& column20_row17 = neighbors[kColumn20Row17Neighbor];
  ...
  const FieldElementT& column20_row24 = neighbors[kColumn20Row24Neighbor];
  const FieldElementT& column20_row30 = neighbors[kColumn20Row30Neighbor];
  const FieldElementT& column20_row38 = neighbors[kColumn20Row38Neighbor];
  const FieldElementT& column20_row46 = neighbors[kColumn20Row46Neighbor];
  const FieldElementT& column20_row54 = neighbors[kColumn20Row54Neighbor];
  const FieldElementT& column20_row81 = neighbors[kColumn20Row81Neighbor];
  const FieldElementT& column20_row145 = neighbors[kColumn20Row145Neighbor];
  const FieldElementT& column20_row209 = neighbors[kColumn20Row209Neighbor];
  const FieldElementT& column20_row4080 = neighbors[kColumn20Row4080Neighbor];
  const FieldElementT& column20_row4082 = neighbors[kColumn20Row4082Neighbor];
  const FieldElementT& column20_row4088 = neighbors[kColumn20Row4088Neighbor];
  const FieldElementT& column20_row4090 = neighbors[kColumn20Row4090Neighbor];
  const FieldElementT& column20_row4092 = neighbors[kColumn20Row4092Neighbor];
  const FieldElementT& column20_row8161 = neighbors[kColumn20Row8161Neighbor];
  const FieldElementT& column20_row8166 = neighbors[kColumn20Row8166Neighbor];
  const FieldElementT& column20_row8176 = neighbors[kColumn20Row8176Neighbor];
  const FieldElementT& column20_row8178 = neighbors[kColumn20Row8178Neighbor];
  const FieldElementT& column20_row8182 = neighbors[kColumn20Row8182Neighbor];
  const FieldElementT& column20_row8184 = neighbors[kColumn20Row8184Neighbor];
  const FieldElementT& column20_row8186 = neighbors[kColumn20Row8186Neighbor];
  const FieldElementT& column20_row8190 = neighbors[kColumn20Row8190Neighbor];
  ...
  const FieldElementT npc_reg_0 =
      ((column17_row0) + (cpu__decode__opcode_range_check__bit_2)) + (FieldElementT::One());
  ...
  const FieldElementT range_check16__diff_0 = (column19_row6) - (column19_row2);
  ...
  const FieldElementT range_check_builtin__value0_0 = column19_row12;
  const FieldElementT range_check_builtin__value1_0 =
      ((range_check_builtin__value0_0) * (offset_size_)) + (column19_row28);
  const FieldElementT range_check_builtin__value2_0 =
      ((range_check_builtin__value1_0) * (offset_size_)) + (column19_row44);
  const FieldElementT range_check_builtin__value3_0 =
      ((range_check_builtin__value2_0) * (offset_size_)) + (column19_row60);
  const FieldElementT range_check_builtin__value4_0 =
      ((range_check_builtin__value3_0) * (offset_size_)) + (column19_row76);
  const FieldElementT range_check_builtin__value5_0 =
      ((range_check_builtin__value4_0) * (offset_size_)) + (column19_row92);
  const FieldElementT range_check_builtin__value6_0 =
      ((range_check_builtin__value5_0) * (offset_size_)) + (column19_row108);
  const FieldElementT range_check_builtin__value7_0 =
      ((range_check_builtin__value6_0) * (offset_size_)) + (column19_row124);
  const FieldElementT ecdsa__signature0__doubling_key__x_squared =
      (column19_row7) * (column19_row7);
  ...
  const FieldElementT ecdsa__signature0__exponentiate_key__bit_0 =
      (column20_row4) - ((column20_row20) + (column20_row20));
...

  {
...

    {
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((column17_row12) + (half_offset_size_)) -
      ...
      }
      {
        ...
        const FieldElementT constraint = (column19_row5) - ((column17_row5) * (column17_row13));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (cpu__decode__opcode_range_check__bit_12) * ((column17_row9) - (column19_row9));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((column17_row5) - (((column17_row0) + (cpu__decode__opcode_range_check__bit_2)) +
                                (FieldElementT::One())));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (cpu__decode__opcode_range_check__bit_12) * ((column19_row0) - (half_offset_size_));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (cpu__decode__opcode_range_check__bit_14) * ((column17_row9) - (column19_row13));
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint =
            (column19_row3) - ((cpu__decode__opcode_range_check__bit_9) * (column17_row9));
        inner_sum += random_coefficients[12] * constraint;
      }
      {
        // Constraint expression for cpu/update_registers/update_pc/tmp1:
        const FieldElementT constraint = (column19_row11) - ((column19_row3) * (column19_row13));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((column19_row11) - (cpu__decode__opcode_range_check__bit_9)) *
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (column19_row17) -
            ((((column19_row1) + ((cpu__decode__opcode_range_check__bit_10) * (column19_row13))) +
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (column19_row25) - ((((cpu__decode__fp_update_regular_0) * (column19_row9)) +
                                 ((cpu__decode__opcode_range_check__bit_13) * (column17_row9))) +
                                ((cpu__decode__opcode_range_check__bit_12) *
                                 ((column19_row1) + (FieldElementT::ConstexprFromBigInt(0x2_Z)))));
...

    {
      ...
      }
      {
        ...
        const FieldElementT constraint = ((column19_row15) + (column19_row31)) -
      ...
      }
      {
        ...
        const FieldElementT constraint = ((column20_row2) * (column20_row2)) -
                                         ((ecdsa__signature0__exponentiate_key__bit_0) *
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((column20_row10) * ((column20_row0) - (column19_row7))) - (FieldElementT::One());
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint = (column19_row1) - (initial_ap_);
        inner_sum += random_coefficients[27] * constraint;
      }
      {
        // Constraint expression for initial_fp:
        const FieldElementT constraint = (column19_row9) - (initial_ap_);
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((((range_check16__perm__interaction_elm_) - (column19_row2)) *
      ...
      }
      {
        ...
        const FieldElementT constraint = (column19_row2) - (range_check_min_);
      ...
      }
      {
        ...
        const FieldElementT constraint = (column17_row102) - (initial_range_check_addr_);
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint = (column19_row1) - (final_ap_);
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint =
            (((range_check16__perm__interaction_elm_) - (column19_row6)) * (column21_inter1_row5)) -
            (((range_check16__perm__interaction_elm_) - (column19_row4)) * (column21_inter1_row1));
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint =
            (column21_inter1_row1) - (range_check16__perm__public_memory_prod_);
        inner_sum += random_coefficients[43] * constraint;
      }
      {
        // Constraint expression for range_check16/maximum:
        const FieldElementT constraint = (column19_row2) - (range_check_max_);
...

  {
...

    {
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (column20_row145) * ((column9_row0) - ((column9_row1) + (column9_row1)));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (column20_row17) - (((column9_row251) - ((column9_row252) + (column9_row252))) *
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (column20_row81) - (((column12_row251) - ((column12_row252) + (column12_row252))) *
...

  {
...

    {
      ...
      }
      {
        ...
        const FieldElementT constraint = (range_check_builtin__value7_0) - (column17_row103);
...

  {
...

    {
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((ecdsa__signature0__exponentiate_generator__bit_0) *
             ((column20_row22) - (ecdsa__generator_points__y))) -
            ((column20_row30) * ((column20_row6) - (ecdsa__generator_points__x)));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((ecdsa__signature0__exponentiate_generator__bit_0) *
             (((column20_row6) + (ecdsa__generator_points__x)) + (column20_row38)));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((column20_row1) * ((column20_row6) - (ecdsa__generator_points__x))) -
            (FieldElementT::One());
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint = column20_row14;
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint = column20_row4;
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint = (column20_row6) - (((ecdsa__sig_config_).shift_point).x);
        inner_sum += random_coefficients[159] * constraint;
      }
      {
        // Constraint expression for ecdsa/signature0/init_gen/y:
        const FieldElementT constraint = (column20_row22) + (((ecdsa__sig_config_).shift_point).y);
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((column20_row8182) + (column19_row4111)) -
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((column20_row8161) * ((column20_row8166) - (column20_row4080))) -
            (FieldElementT::One());
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ((column20_row8184) + (((ecdsa__sig_config_).shift_point).y)) -
            ((column20_row4082) * ((column20_row8176) - (((ecdsa__sig_config_).shift_point).x)));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            (((column20_row8176) + (((ecdsa__sig_config_).shift_point).x)) + (column20_row4));
        inner_sum += random_coefficients[168] * constraint;
      }
      {
        // Constraint expression for ecdsa/signature0/extract_r/x_diff_inv:
        const FieldElementT constraint =
            ((column20_row8178) * ((column20_row8176) - (((ecdsa__sig_config_).shift_point).x))) -
            (FieldElementT::One());
      ...
      }
      {
        ...
        const FieldElementT constraint = (column17_row4119) - (column20_row14);
        inner_sum += random_coefficients[177] * constraint;
      }
      {
        // Constraint expression for ecdsa/pubkey_value0:
        const FieldElementT constraint = (column17_row23) - (column19_row7);
...

  {
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint = (column20_row0) - (((ecdsa__sig_config_).shift_point).x);
        inner_sum += random_coefficients[161] * constraint;
      }
      {
        // Constraint expression for ecdsa/signature0/init_key/y:
        const FieldElementT constraint = (column20_row8) - (((ecdsa__sig_config_).shift_point).y);
        inner_sum += random_coefficients[162] * constraint;
      }
      {
        // Constraint expression for ecdsa/signature0/r_and_w_nonzero:
        const FieldElementT constraint =
            ((column20_row4) * (column20_row4092)) - (FieldElementT::One());
...
template <typename FieldElementT>
std::vector<FieldElementT> CpuAirDefinition<FieldElementT, 1>::DomainEvalsAtPoint(
...
template <typename FieldElementT>
std::vector<uint64_t> CpuAirDefinition<FieldElementT, 1>::ParseDynamicParams(
...
template <typename FieldElementT>
TraceGenerationContext CpuAirDefinition<FieldElementT, 1>::GetTraceGenerationContext() const {
  TraceGenerationContext ctx;

  ASSERT_RELEASE(IsPowerOfTwo(SafeDiv(trace_length_, 8192)), "Dimension should be a power of 2.");

  ASSERT_RELEASE(((SafeDiv(trace_length_, 8192)) - (1)) >= (0), "step must not exceed dimension.");
  ...
  ASSERT_RELEASE(((SafeDiv(trace_length_, 128)) - (1)) >= (0), "Index out of range.");
  ...
  ASSERT_RELEASE(((SafeDiv(trace_length_, 128)) - (4)) >= (0), "step must not exceed dimension.");

  ASSERT_RELEASE(((SafeDiv(trace_length_, 128)) - (3)) >= (0), "Index out of range.");

  ASSERT_RELEASE(((SafeDiv(trace_length_, 128)) - (2)) >= (0), "Index out of range.");
  ...
  ASSERT_RELEASE(((trace_length_) - (23)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (15)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (31)) >= (0), "Offset must be smaller than trace length.");
  ...
  ASSERT_RELEASE(((trace_length_) - (146)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (82)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (210)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (4093)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (8191)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (8162)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (4083)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (8179)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (4091)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (8187)) >= (0), "Offset must be smaller than trace length.");
  ...
  ctx.AddVirtualColumn(
      "range_check16_pool",
      VirtualColumn(/*column=*/kColumn19Column, /*step=*/4, /*row_offset=*/0));
  ctx.AddVirtualColumn(
  ...
  ctx.AddVirtualColumn(
      "cpu/registers/ap", VirtualColumn(/*column=*/kColumn19Column, /*step=*/16, /*row_offset=*/1));
  ctx.AddVirtualColumn(
      "cpu/registers/fp", VirtualColumn(/*column=*/kColumn19Column, /*step=*/16, /*row_offset=*/9));
  ctx.AddVirtualColumn(
  ...
  ctx.AddVirtualColumn(
      ...
      VirtualColumn(/*column=*/kColumn19Column, /*step=*/4, /*row_offset=*/2));
  ctx.AddVirtualColumn(
  ...
  ctx.AddVirtualColumn(
      ...
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/256, /*row_offset=*/17));
  ctx.AddVirtualColumn(
      "pedersen/hash2/ec_subset_sum/bit_unpacking/prod_ones192",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/256, /*row_offset=*/145));
  ctx.AddVirtualColumn(
  ...
  ctx.AddVirtualColumn(
      ...
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/256, /*row_offset=*/81));
  ctx.AddVirtualColumn(
      "pedersen/hash3/ec_subset_sum/bit_unpacking/prod_ones192",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/256, /*row_offset=*/209));
  ctx.AddVirtualColumn(
  ...
  ctx.AddVirtualColumn(
      ...
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/32, /*row_offset=*/6));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/exponentiate_generator/partial_sum/y",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/32, /*row_offset=*/22));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/exponentiate_generator/slope",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/32, /*row_offset=*/30));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/exponentiate_generator/selector",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/32, /*row_offset=*/14));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/exponentiate_generator/x_diff_inv",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/32, /*row_offset=*/1));
  ctx.AddVirtualColumn(
  ...
  ctx.AddVirtualColumn(
      ...
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/8192, /*row_offset=*/8190));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/add_results_inv",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/8192, /*row_offset=*/8161));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/extract_r_slope",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/8192, /*row_offset=*/4082));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/extract_r_inv",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/8192, /*row_offset=*/8178));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/z_inv",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/8192, /*row_offset=*/4090));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/r_w_inv",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/4096, /*row_offset=*/4092));
  ctx.AddVirtualColumn(
      "ecdsa/signature0/q_x_squared",
      VirtualColumn(/*column=*/kColumn20Column, /*step=*/8192, /*row_offset=*/8186));
...
template <typename FieldElementT>
std::vector<std::pair<int64_t, uint64_t>> CpuAirDefinition<FieldElementT, 1>::GetMask() const {
  ...
  mask.emplace_back(25, kColumn19Column);
  mask.emplace_back(28, kColumn19Column);
  mask.emplace_back(31, kColumn19Column);
  ...
  mask.emplace_back(4103, kColumn19Column);
  mask.emplace_back(4111, kColumn19Column);
  ...
  mask.emplace_back(16, kColumn20Column);
  mask.emplace_back(17, kColumn20Column);
  mask.emplace_back(20, kColumn20Column);
  mask.emplace_back(22, kColumn20Column);
  mask.emplace_back(24, kColumn20Column);
  mask.emplace_back(30, kColumn20Column);
  mask.emplace_back(38, kColumn20Column);
  mask.emplace_back(46, kColumn20Column);
  mask.emplace_back(54, kColumn20Column);
  mask.emplace_back(81, kColumn20Column);
  mask.emplace_back(145, kColumn20Column);
  mask.emplace_back(209, kColumn20Column);
  mask.emplace_back(4080, kColumn20Column);
  mask.emplace_back(4082, kColumn20Column);
  mask.emplace_back(4088, kColumn20Column);
  mask.emplace_back(4090, kColumn20Column);
  mask.emplace_back(4092, kColumn20Column);
  mask.emplace_back(8161, kColumn20Column);
  mask.emplace_back(8166, kColumn20Column);
  mask.emplace_back(8176, kColumn20Column);
  mask.emplace_back(8178, kColumn20Column);
  mask.emplace_back(8182, kColumn20Column);
  mask.emplace_back(8184, kColumn20Column);
  mask.emplace_back(8186, kColumn20Column);
  mask.emplace_back(8190, kColumn20Column);
