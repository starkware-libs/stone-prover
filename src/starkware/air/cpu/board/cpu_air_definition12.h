...
#ifndef STARKWARE_AIR_CPU_BOARD_CPU_AIR12_H_
#define STARKWARE_AIR_CPU_BOARD_CPU_AIR12_H_
...
class CpuAirDefinition<FieldElementT, 12> : public Air {
 public:
  ...
  static constexpr uint64_t kPoseidonRatio = 64;
  static constexpr uint64_t kPoseidonRowRatio = 1024;
  ...
  static constexpr char kLayoutName[] = "recursive_with_poseidon";
  static constexpr BigInt<4> kLayoutCode = 0x7265637572736976655f776974685f706f736569646f6e_Z;
  ...
  static constexpr std::array<std::string_view, 7> kSegmentNames = {
      "program", "execution", "output", "pedersen", "range_check", "bitwise", "poseidon"};
  ...
  enum Neighbors {
    ...
    kColumn1Row42Neighbor,
    kColumn1Row43Neighbor,
    kColumn1Row74Neighbor,
    kColumn1Row75Neighbor,
    kColumn1Row106Neighbor,
    kColumn1Row138Neighbor,
    kColumn1Row139Neighbor,
    kColumn1Row171Neighbor,
    kColumn1Row202Neighbor,
    kColumn1Row203Neighbor,
    kColumn1Row234Neighbor,
    kColumn1Row235Neighbor,
    kColumn1Row266Neighbor,
    kColumn1Row267Neighbor,
    kColumn1Row298Neighbor,
    kColumn1Row394Neighbor,
    kColumn1Row458Neighbor,
    kColumn1Row459Neighbor,
    kColumn1Row714Neighbor,
    kColumn1Row715Neighbor,
    kColumn1Row778Neighbor,
    kColumn1Row779Neighbor,
    kColumn1Row970Neighbor,
    kColumn1Row971Neighbor,
    kColumn1Row1034Neighbor,
    kColumn1Row1035Neighbor,
    kColumn1Row2058Neighbor,
    kColumn1Row2059Neighbor,
    kColumn1Row4106Neighbor,
    kColumn2Row0Neighbor,
    kColumn2Row1Neighbor,
    kColumn2Row2Neighbor,
    kColumn2Row3Neighbor,
    ...
    kColumn3Row20Neighbor,
    kColumn3Row24Neighbor,
    kColumn3Row28Neighbor,
    kColumn3Row32Neighbor,
    kColumn3Row36Neighbor,
    kColumn3Row40Neighbor,
    kColumn3Row44Neighbor,
    kColumn3Row48Neighbor,
    kColumn3Row52Neighbor,
    kColumn3Row56Neighbor,
    kColumn3Row60Neighbor,
    kColumn3Row64Neighbor,
    kColumn3Row66Neighbor,
    kColumn3Row128Neighbor,
    kColumn3Row130Neighbor,
    kColumn3Row176Neighbor,
    kColumn3Row180Neighbor,
    kColumn3Row184Neighbor,
    kColumn3Row188Neighbor,
    kColumn3Row192Neighbor,
    kColumn3Row194Neighbor,
    kColumn3Row240Neighbor,
    kColumn3Row244Neighbor,
    kColumn3Row248Neighbor,
    ...
    kColumn4Row6Neighbor,
    kColumn4Row7Neighbor,
    kColumn4Row8Neighbor,
    kColumn4Row9Neighbor,
    kColumn4Row11Neighbor,
    kColumn4Row12Neighbor,
    kColumn4Row13Neighbor,
    kColumn4Row44Neighbor,
    kColumn4Row76Neighbor,
    kColumn4Row108Neighbor,
    kColumn4Row140Neighbor,
    kColumn4Row172Neighbor,
    kColumn4Row204Neighbor,
    kColumn4Row236Neighbor,
    kColumn4Row1539Neighbor,
    kColumn4Row1547Neighbor,
    kColumn4Row1571Neighbor,
    kColumn4Row1579Neighbor,
    kColumn4Row2011Neighbor,
    kColumn4Row2019Neighbor,
    kColumn4Row2041Neighbor,
    kColumn4Row2045Neighbor,
    kColumn4Row2047Neighbor,
    kColumn4Row2049Neighbor,
    kColumn4Row2051Neighbor,
    kColumn4Row2053Neighbor,
    kColumn4Row4089Neighbor,
    ...
    kColumn5Row14Neighbor,
    kColumn5Row16Neighbor,
    kColumn5Row17Neighbor,
    kColumn5Row22Neighbor,
    kColumn5Row24Neighbor,
    kColumn5Row25Neighbor,
    kColumn5Row30Neighbor,
    kColumn5Row33Neighbor,
    kColumn5Row38Neighbor,
    kColumn5Row41Neighbor,
    kColumn5Row46Neighbor,
    kColumn5Row49Neighbor,
    kColumn5Row54Neighbor,
    kColumn5Row57Neighbor,
    kColumn5Row65Neighbor,
    kColumn5Row73Neighbor,
    kColumn5Row81Neighbor,
    kColumn5Row89Neighbor,
    kColumn5Row97Neighbor,
    kColumn5Row105Neighbor,
    kColumn5Row137Neighbor,
    kColumn5Row169Neighbor,
    kColumn5Row201Neighbor,
    kColumn5Row393Neighbor,
    kColumn5Row409Neighbor,
    kColumn5Row425Neighbor,
    kColumn5Row457Neighbor,
    kColumn5Row473Neighbor,
    kColumn5Row489Neighbor,
    kColumn5Row521Neighbor,
    kColumn5Row553Neighbor,
    kColumn5Row585Neighbor,
    kColumn5Row609Neighbor,
    kColumn5Row625Neighbor,
    kColumn5Row641Neighbor,
    kColumn5Row657Neighbor,
    kColumn5Row673Neighbor,
    kColumn5Row689Neighbor,
    kColumn5Row905Neighbor,
    kColumn5Row921Neighbor,
    kColumn5Row937Neighbor,
    kColumn5Row969Neighbor,
    kColumn5Row982Neighbor,
    kColumn5Row985Neighbor,
    kColumn5Row998Neighbor,
    kColumn5Row1001Neighbor,
    kColumn5Row1014Neighbor,
    kColumn6Inter1Row0Neighbor,
    kColumn6Inter1Row1Neighbor,
    kColumn6Inter1Row2Neighbor,
    kColumn6Inter1Row3Neighbor,
    kColumn7Inter1Row0Neighbor,
    kColumn7Inter1Row1Neighbor,
    kColumn7Inter1Row2Neighbor,
    kColumn7Inter1Row5Neighbor,
    // Number of neighbors.
    kNumNeighbors,
  };
  ...
  enum Constraints {
    ...
    kPoseidonParam_0InitInputOutputAddrCond,                        // Constraint 93.
    kPoseidonParam_0AddrInputOutputStepCond,                        // Constraint 94.
    kPoseidonParam_1InitInputOutputAddrCond,                        // Constraint 95.
    kPoseidonParam_1AddrInputOutputStepCond,                        // Constraint 96.
    kPoseidonParam_2InitInputOutputAddrCond,                        // Constraint 97.
    kPoseidonParam_2AddrInputOutputStepCond,                        // Constraint 98.
    kPoseidonPoseidonFullRoundsState0SquaringCond,                  // Constraint 99.
    kPoseidonPoseidonFullRoundsState1SquaringCond,                  // Constraint 100.
    kPoseidonPoseidonFullRoundsState2SquaringCond,                  // Constraint 101.
    kPoseidonPoseidonPartialRoundsState0SquaringCond,               // Constraint 102.
    kPoseidonPoseidonPartialRoundsState1SquaringCond,               // Constraint 103.
    kPoseidonPoseidonAddFirstRoundKey0Cond,                         // Constraint 104.
    kPoseidonPoseidonAddFirstRoundKey1Cond,                         // Constraint 105.
    kPoseidonPoseidonAddFirstRoundKey2Cond,                         // Constraint 106.
    kPoseidonPoseidonFullRound0Cond,                                // Constraint 107.
    kPoseidonPoseidonFullRound1Cond,                                // Constraint 108.
    kPoseidonPoseidonFullRound2Cond,                                // Constraint 109.
    kPoseidonPoseidonLastFullRound0Cond,                            // Constraint 110.
    kPoseidonPoseidonLastFullRound1Cond,                            // Constraint 111.
    kPoseidonPoseidonLastFullRound2Cond,                            // Constraint 112.
    kPoseidonPoseidonCopyPartialRounds0I0Cond,                      // Constraint 113.
    kPoseidonPoseidonCopyPartialRounds0I1Cond,                      // Constraint 114.
    kPoseidonPoseidonCopyPartialRounds0I2Cond,                      // Constraint 115.
    kPoseidonPoseidonMarginFullToPartial0Cond,                      // Constraint 116.
    kPoseidonPoseidonMarginFullToPartial1Cond,                      // Constraint 117.
    kPoseidonPoseidonMarginFullToPartial2Cond,                      // Constraint 118.
    kPoseidonPoseidonPartialRound0Cond,                             // Constraint 119.
    kPoseidonPoseidonPartialRound1Cond,                             // Constraint 120.
    kPoseidonPoseidonMarginPartialToFull0Cond,                      // Constraint 121.
    kPoseidonPoseidonMarginPartialToFull1Cond,                      // Constraint 122.
    kPoseidonPoseidonMarginPartialToFull2Cond,                      // Constraint 123.
...
#endif  // STARKWARE_AIR_CPU_BOARD_CPU_AIR12_H_
