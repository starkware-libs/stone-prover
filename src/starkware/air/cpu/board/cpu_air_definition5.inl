...
FractionFieldElement<FieldElementT> CpuAirDefinition<FieldElementT, 5>::ConstraintsEval(
  ...
  // domain25 = point - gen^(trace_length - 8).
  const FieldElementT& domain25 = (point) - (shifts[23]);
  // domain26 = point - gen^(trace_length - 4).
  const FieldElementT& domain26 = (point) - (shifts[24]);
  // domain27 = point - gen^(trace_length - 128).
  const FieldElementT& domain27 = (point) - (shifts[25]);
  // domain28 = point - gen^(trace_length - 8192).
  const FieldElementT& domain28 = (point) - (shifts[26]);
  // domain29 = point - gen^(trace_length - 1024).
  const FieldElementT& domain29 = (point) - (shifts[27]);

  ASSERT_VERIFIER(neighbors.size() == 246, "neighbors should contain 246 elements.");
...

  {
...

    {
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((((cpu__decode__opcode_range_check__bit_0) * (column19_row11)) +
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((((cpu__decode__opcode_range_check__bit_1) * (column19_row11)) +
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((((((cpu__decode__opcode_range_check__bit_2) * (column17_row0)) +
                ((cpu__decode__opcode_range_check__bit_4) * (column19_row3))) +
               ((cpu__decode__opcode_range_check__bit_3) * (column19_row11))) +
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((((cpu__decode__opcode_range_check__bit_5) * ((column17_row5) + (column17_row13))) +
              ((cpu__decode__opcode_range_check__bit_6) * (column19_row7))) +
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (cpu__decode__opcode_range_check__bit_12) * ((column17_row9) - (column19_row11));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (cpu__decode__opcode_range_check__bit_14) * ((column17_row9) - (column19_row15));
...

    {
      ...
      FieldElementT inner_sum = FieldElementT::Zero();
      {
        ...
        const FieldElementT constraint =
            (column20_row0) - ((cpu__decode__opcode_range_check__bit_9) * (column17_row9));
      ...
      }
      {
        ...
        const FieldElementT constraint =
            ...
            ((((cpu__decode__flag_pc_update_regular_0) * (npc_reg_0)) +
              ((cpu__decode__opcode_range_check__bit_7) * (column19_row15))) +
             ((cpu__decode__opcode_range_check__bit_8) * ((column17_row0) + (column19_row15))));
        inner_sum += random_coefficients[14] * constraint;
      }
      {
        // Constraint expression for cpu/update_registers/update_pc/pc_cond_positive:
        const FieldElementT constraint =
            ((column20_row8) - (cpu__decode__opcode_range_check__bit_9)) *
      ...
      }
      {
        ...
        const FieldElementT constraint =
            (column19_row19) -
            ((((column19_row3) + ((cpu__decode__opcode_range_check__bit_10) * (column19_row15))) +
...
template <typename FieldElementT>
std::vector<uint64_t> CpuAirDefinition<FieldElementT, 5>::ParseDynamicParams(
...
TraceGenerationContext CpuAirDefinition<FieldElementT, 5>::GetTraceGenerationContext() const {
  ...
  ASSERT_RELEASE(((trace_length_) - (148)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (84)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (212)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (4095)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (8190)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (8164)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (4082)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (8178)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (4090)) >= (0), "Offset must be smaller than trace length.");

  ASSERT_RELEASE(((trace_length_) - (8186)) >= (0), "Offset must be smaller than trace length.");
  ...
  ctx.AddVirtualColumn(
      ...
      VirtualColumn(/*column=*/kColumn17Column, /*step=*/256, /*row_offset=*/150));
  ctx.AddVirtualColumn(
      "bitwise/var_pool/value",
      VirtualColumn(/*column=*/kColumn17Column, /*step=*/256, /*row_offset=*/151));
  ctx.AddVirtualColumn(
      "bitwise/x/addr",
