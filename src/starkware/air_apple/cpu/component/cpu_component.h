...
class CpuComponent {
  ...
  */
  ...
  static constexpr uint64_t kOffsetBits = 16;
 ...
 private:
  ...
  // Flag locations.
  static constexpr uint64_t kResAddBit = 5;
  static constexpr uint64_t kResMulBit = 6;
  static constexpr uint64_t kPcJnzBit = 9;
