...
class DilutedCheckComponentProverContext0 {
  ...
  */
  DilutedCheckComponentProverContext0(
      const std::string& name, uint64_t spacing, uint64_t n_bits, const TraceGenerationContext& ctx,
...
class DilutedCheckComponentProverContext1 {
 public:
  ...
  DilutedCheckComponentProverContext1(
      uint64_t spacing, uint64_t n_bits, const PermutationComponent<FieldElementT>&& perm_component,
  ...
  */
  static FieldElementT ExpectedFinalCumulativeValue(
      uint64_t spacing, uint64_t n_bits, const FieldElementT& interaction_z,
